...
public:
	AsmGraphicsEngine();
	 ...
	 Vector2d rotate(Vector2d point) const override;
	 Vector2d rotateX(Vector3d point) const override;
	 Vector2d rotateY(Vector2d point) const override;
	 Vector2d rotateZ(Vector2d point) const override;
	~AsmGraphicsEngine();
};
