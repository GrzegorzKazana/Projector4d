...
public:
	...
	virtual Vector2d rotate(Vector2d point) const = 0;
	virtual Vector2d rotateX(Vector3d point) const = 0;
	virtual Vector2d rotateY(Vector2d point) const = 0;
	virtual Vector2d rotateZ(Vector2d point) const = 0;
