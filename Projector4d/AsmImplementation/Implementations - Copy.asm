...
;	outarr: 32bit, address to output double array
...
;	EAX, ECX, EDX, XMM0
; decription:
;	scales array of doubles of given size
; -------------------------------------------------------------------------------
scaleMatrix proc cols: DWORD, rows: DWORD, arr: DWORD, outarr: DWORD, scale: REAL8
	push ebx
...
colloop:
	...
	sub eax, arr
	add eax, outarr						; calculate pointer to output array
...
finished:
	pop ebx
	ret								; inner function, clear stack
scaleMatrix endp
; -------------------------------------------------------------------------------
